                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-6 text-sm">
                      <div className="space-y-2">
                        ...
                        <div>vs Team Avg: <span className={homeWon ? "text-green-600" : "text-red-600"}>{(homeTeam?.pointsFor / (homeTeam?.wins + homeTeam?.losses) || 0).toFixed(2)} ({homeWon ? '+' : '-'}{((matchup.homeScore - (homeTeam?.pointsFor / (homeTeam?.wins + homeTeam?.losses) || 0)) / (homeTeam?.pointsFor / (homeTeam?.wins + homeTeam?.losses) || 1) * 100).toFixed(2)}%)</span></div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div>vs Team Avg: <span className={awayWon ? "text-green-600" : "text-red-600"}>{(awayTeam?.pointsFor / (awayTeam?.wins + awayTeam?.losses) || 0).toFixed(2)} ({awayWon ? '+' : '-'}{((matchup.awayScore - (awayTeam?.pointsFor / (awayTeam?.wins + awayTeam?.losses) || 0)) / (awayTeam?.pointsFor / (awayTeam?.wins + awayTeam?.losses) || 1) * 100).toFixed(2)}%)</span></div>
