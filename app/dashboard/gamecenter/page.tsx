            ...
            <div className="w-64 bg-muted/50 border-r p-4 space-y-2 rounded-bl-lg">
              ...
              <div className="py-2">
                ...
                >
                  <div className="flex items-center space-x-2">
                    <div className="w-8 h-8 bg-muted rounded-full flex items-center justify-center text-sm">
                      {(mostDominatingData?.team?.ownerDisplayName || mostDominatingData?.team?.name || "?").charAt(0)}
                    </div>
                    <span className="text-sm">{mostDominatingData?.team?.ownerDisplayName || mostDominatingData?.team?.name || "Loading..."}</span>
                  </div>
                </button>
              </div>
