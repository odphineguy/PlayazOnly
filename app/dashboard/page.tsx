...
export default function LeagueHome() {
  // Mock data for now - will be replaced with actual Convex queries
          ...
          <TabsContent value="transactions" className="space-y-4">
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    { type: "Trade", description: "Team Alpha traded RB Saquon Barkley to Dynasty Kings for WR Davante Adams", date: "2024-10-27", teams: ["Team Alpha", "Dynasty Kings"] },
                    { type: "Waiver", description: "Mad Men added RB Gus Edwards from waivers", date: "2024-10-26", teams: ["Mad Men"] },
                    { type: "Free Agent", description: "Gridiron Gods dropped QB Russell Wilson", date: "2024-10-25", teams: ["Gridiron Gods"] },
                    { type: "Trade", description: "Fantasy Legends traded WR Tyreek Hill to Champions United for RB Derrick Henry", date: "2024-10-24", teams: ["Fantasy Legends", "Champions United"] },
                    { type: "Waiver", description: "Elite Squad added WR Amari Cooper from waivers", date: "2024-10-23", teams: ["Elite Squad"] },
          ...
          <TabsContent value="draft" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>2024 Draft Results and Analysis</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8">
                  <Target className="h-12 w-12 mx-auto text-muted-foreground mb-4" />
                  <h3 className="text-lg font-medium mb-2">Draft Analysis Coming Soon</h3>
                  <p className="text-muted-foreground">
                    Import your ESPN draft data to see detailed analysis of draft picks, 
